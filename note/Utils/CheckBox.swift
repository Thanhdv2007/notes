...
class CheckBox: NSObject {
    ...
    private var normalAnimation:CABasicAnimation = {
        ...
        nAnim.fillMode = CAMediaTimingFillMode.forwards
        nAnim.timingFunction = CAMediaTimingFunction(name: CAMediaTimingFunctionName.linear)
    ...
    private var scaleAnimation:CABasicAnimation = {
        ...
        sAnim.toValue = 1
        sAnim.duration = 0.5
        sAnim.fillMode = CAMediaTimingFillMode.forwards
        sAnim.timingFunction = CAMediaTimingFunction(name: CAMediaTimingFunctionName.default)
        return sAnim
